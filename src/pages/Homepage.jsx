    ...
    <div className="w-full h-full">
      ...
      <div className="w-full grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-3 p-3">
        {data.map((item, index) => (
          <div
            key={index}
            className="relative group p-3 border rounded overflow-hidden"
          >
            {active === "/users" && (
              <>
                <div>
                  ...
                  <p>
                    LastName: <span>{item.lastName}</span>
                  </p>
                  <p>
            ...
            {active === "/comments" && (
              <>
                <div>
                  ...
                  <p className="my-1">
                    Comment: <span>{item.body}</span>
                  </p>
                  <span className="flex text-lg items-center gap-2 ">
                    <ThumbsUp className="size-5" /> {item.likes}
                  </span>
                </div>
              </>
            )}
            ...
            {active === "/products" && (
              <>
                ...
                <div className="transition-all duration-300 transform xl:translate-y-10 group-hover:translate-y-0">
                  ...
                  <button className="cursor-pointer w-full p-2 border my-2 rounded-2xl xl:opacity-0 xl:translate-y-5 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ">
                    Add To Basket
                  </button>
                </div>
              </>
